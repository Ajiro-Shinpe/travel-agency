...
A responsive, configuration-driven travel website for a Karachi-based agency. The site supports both Islamic tourism and general holiday-planning content through the shared configuration in `src/agencyConfig.ts`.
